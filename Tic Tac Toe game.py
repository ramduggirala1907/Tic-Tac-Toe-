...
ram = tk.Tk()
ram.geometry('800x500')
ram.title("Tic Tac Toe - CopyAssignment")

tk.Label(ram, text="Game Aadukora puka", font=('itallic', 45, ), fg='red').pack()
tk.Label(ram, text="Tic-Tac-Toe", font=('italic', 25)).pack()
status_label = tk.Label(ram, text="X's turn", font=('italic', 15), bg='blue', fg='snow')
...
playAgain = tk.Button(ram, text='Play again', font=('Ariel', 15), fg='red', command=playAgain)

currentChar = "X"

play_area = tk.Frame(ram, width=500, height=300, bg='white')
xoPointCountr = []
xPointCountr = []
oPointCountr = []
class XOPoint:
